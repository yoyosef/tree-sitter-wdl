...
static uint16_t ts_parse_table[STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [292] = {
    [sym_command_part_var] = STATE(364),
    [aux_sym_command_repeat1] = STATE(366),
    [sym_command_part] = STATE(366),
    [sym_command_part_string] = ACTIONS(731),
    [anon_sym_DOLLAR] = ACTIONS(733),
  },
  [293] = {
    [sym_command_part_var] = STATE(364),
    [aux_sym_command_repeat1] = STATE(367),
    [sym_command_part] = STATE(367),
    [sym_command_part_string] = ACTIONS(731),
    [anon_sym_DOLLAR] = ACTIONS(733),
  },
  [294] = {
    [sym_parameter_meta_kv] = STATE(368),
    [aux_sym_parameter_meta_repeat1] = STATE(369),
    [sym_identifier] = STATE(320),
    [aux_sym_identifier_token1] = ACTIONS(7),
    [anon_sym_meta] = ACTIONS(637),
    [anon_sym_RBRACE] = ACTIONS(639),
  ...
  [295] = {
    [sym_array_type] = STATE(5),
    [sym_primitive_type] = STATE(5),
    [sym_task_output_kv] = STATE(371),
    [aux_sym_task_output_repeat1] = STATE(371),
    [sym_map_type] = STATE(5),
    [sym_type] = STATE(372),
    [anon_sym_File] = ACTIONS(259),
    [sym_object_type] = ACTIONS(310),
  ...
  [297] = {
    ...
    [anon_sym_parameter_meta] = ACTIONS(744),
    [anon_sym_runtime] = ACTIONS(747),
    [anon_sym_command] = ACTIONS(750),
  ...
  [364] = {
    [sym_command_part_string] = ACTIONS(844),
  ...
  [366] = {
    [sym_command_part_var] = STATE(364),
    [aux_sym_command_repeat1] = STATE(422),
    [sym_command_part] = STATE(422),
  ...
  [367] = {
    [sym_command_part_var] = STATE(364),
    [aux_sym_command_repeat1] = STATE(423),
    [sym_command_part] = STATE(423),
    [anon_sym_DOLLAR] = ACTIONS(733),
    [sym_command_part_string] = ACTIONS(731),
  ...
  [369] = {
    [sym_parameter_meta_kv] = STATE(368),
    [aux_sym_parameter_meta_repeat1] = STATE(425),
    [sym_identifier] = STATE(320),
    [aux_sym_identifier_token1] = ACTIONS(7),
    [anon_sym_meta] = ACTIONS(795),
    [anon_sym_RBRACE] = ACTIONS(797),
  ...
  [370] = {
    [anon_sym_meta] = ACTIONS(852),
    [anon_sym_RBRACE] = ACTIONS(852),
    [anon_sym_parameter_meta] = ACTIONS(852),
    [anon_sym_runtime] = ACTIONS(852),
    [anon_sym_command] = ACTIONS(852),
    [anon_sym_output] = ACTIONS(852),
  },
  [371] = {
    [sym_array_type] = STATE(5),
    [sym_primitive_type] = STATE(5),
    [sym_task_output_kv] = STATE(427),
    [aux_sym_task_output_repeat1] = STATE(427),
    [sym_map_type] = STATE(5),
    [sym_type] = STATE(372),
    [anon_sym_File] = ACTIONS(259),
    [sym_object_type] = ACTIONS(310),
  ...
  [420] = {
    [sym_string_literal] = STATE(13),
    [sym_math_expression] = STATE(13),
    [sym_var_option] = STATE(468),
    [sym_var_option_key] = STATE(466),
    [sym_expression] = STATE(467),
    [sym_parentheses_expression] = STATE(13),
    [sym_equality_expression] = STATE(13),
    [aux_sym_command_part_var_repeat1] = STATE(468),
    [sym_identifier] = STATE(13),
    [sym_boolean] = STATE(13),
    [sym_dictionary_expression] = STATE(13),
    [sym_bracket_expression] = STATE(13),
    ...
    [anon_sym_LBRACE] = ACTIONS(27),
    [anon_sym_quote] = ACTIONS(930),
    [anon_sym_LPAREN] = ACTIONS(31),
    [sym_integer] = ACTIONS(25),
    [anon_sym_sep] = ACTIONS(930),
    [anon_sym_DASH] = ACTIONS(932),
  },
  [421] = {
    [anon_sym_meta] = ACTIONS(936),
    [anon_sym_RBRACE] = ACTIONS(936),
    [anon_sym_parameter_meta] = ACTIONS(936),
    [anon_sym_runtime] = ACTIONS(936),
    [anon_sym_command] = ACTIONS(936),
    [anon_sym_output] = ACTIONS(936),
  },
  [422] = {
    [sym_command_part_var] = STATE(364),
    [aux_sym_command_repeat1] = STATE(422),
    [sym_command_part] = STATE(422),
    [anon_sym_GT_GT_GT] = ACTIONS(938),
    [sym_command_part_string] = ACTIONS(940),
  ...
  [426] = {
    [anon_sym_meta] = ACTIONS(946),
    [anon_sym_RBRACE] = ACTIONS(946),
    [anon_sym_parameter_meta] = ACTIONS(946),
    [anon_sym_runtime] = ACTIONS(946),
    [anon_sym_command] = ACTIONS(946),
    [anon_sym_output] = ACTIONS(946),
  },
  [427] = {
    [sym_array_type] = STATE(5),
    [sym_primitive_type] = STATE(5),
    ...
    [sym_map_type] = STATE(5),
    [sym_type] = STATE(372),
    [anon_sym_File] = ACTIONS(948),
    [sym_object_type] = ACTIONS(951),
  ...
  [468] = {
    [sym_string_literal] = STATE(13),
    [sym_math_expression] = STATE(13),
    [sym_var_option] = STATE(508),
    [sym_var_option_key] = STATE(466),
    [sym_expression] = STATE(507),
    [sym_parentheses_expression] = STATE(13),
    [sym_equality_expression] = STATE(13),
    [aux_sym_command_part_var_repeat1] = STATE(508),
    [sym_identifier] = STATE(13),
    [sym_boolean] = STATE(13),
    [sym_dictionary_expression] = STATE(13),
    [sym_bracket_expression] = STATE(13),
  ...
  [501] = {
    ...
    [aux_sym_identifier_token1] = ACTIONS(1057),
  ...
  [506] = {
    [sym_command_part_string] = ACTIONS(1073),
  ...
  [508] = {
    ...
    [aux_sym_identifier_token1] = ACTIONS(1080),
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [733] = {.count = 1, .reusable = true}, SHIFT(365),
  ...
  [742] = {.count = 1, .reusable = true}, REDUCE(aux_sym_task_sections_repeat1, 2),
  [744] = {.count = 2, .reusable = true}, REDUCE(aux_sym_task_sections_repeat1, 2), SHIFT_REPEAT(229),
  [747] = {.count = 2, .reusable = true}, REDUCE(aux_sym_task_sections_repeat1, 2), SHIFT_REPEAT(231),
  [750] = {.count = 2, .reusable = true}, REDUCE(aux_sym_task_sections_repeat1, 2), SHIFT_REPEAT(228),
  [753] = {.count = 2, .reusable = true}, REDUCE(aux_sym_task_sections_repeat1, 2), SHIFT_REPEAT(230),
  ...
  [844] = {.count = 1, .reusable = true}, REDUCE(sym_command_part, 1),
  [846] = {.count = 1, .reusable = true}, SHIFT(420),
  [848] = {.count = 1, .reusable = true}, SHIFT(421),
  [850] = {.count = 1, .reusable = true}, SHIFT(424),
  [852] = {.count = 1, .reusable = true}, REDUCE(sym_task_output, 3),
  [854] = {.count = 1, .reusable = true}, SHIFT(426),
  ...
  [928] = {.count = 1, .reusable = false}, SHIFT(462),
  [930] = {.count = 1, .reusable = false}, SHIFT(463),
  [932] = {.count = 1, .reusable = true}, SHIFT(464),
  [934] = {.count = 1, .reusable = false}, SHIFT(465),
  [936] = {.count = 1, .reusable = true}, REDUCE(sym_command, 4),
  [938] = {.count = 1, .reusable = true}, REDUCE(aux_sym_command_repeat1, 2),
  [940] = {.count = 2, .reusable = true}, REDUCE(aux_sym_command_repeat1, 2), SHIFT_REPEAT(364),
  [943] = {.count = 2, .reusable = true}, REDUCE(aux_sym_command_repeat1, 2), SHIFT_REPEAT(365),
  [946] = {.count = 1, .reusable = true}, REDUCE(sym_task_output, 4),
  [948] = {.count = 2, .reusable = true}, REDUCE(aux_sym_task_output_repeat1, 2), SHIFT_REPEAT(2),
  [951] = {.count = 2, .reusable = true}, REDUCE(aux_sym_task_output_repeat1, 2), SHIFT_REPEAT(5),
  [954] = {.count = 2, .reusable = true}, REDUCE(aux_sym_task_output_repeat1, 2), SHIFT_REPEAT(18),
  [957] = {.count = 1, .reusable = true}, REDUCE(aux_sym_task_output_repeat1, 2),
  [959] = {.count = 2, .reusable = true}, REDUCE(aux_sym_task_output_repeat1, 2), SHIFT_REPEAT(15),
  [962] = {.count = 1, .reusable = true}, SHIFT(469),
  ...
  [1023] = {.count = 1, .reusable = true}, SHIFT(501),
  [1025] = {.count = 1, .reusable = true}, SHIFT(502),
  [1027] = {.count = 1, .reusable = true}, SHIFT(503),
  [1029] = {.count = 1, .reusable = true}, SHIFT(504),
  [1031] = {.count = 1, .reusable = true}, SHIFT(505),
  [1033] = {.count = 1, .reusable = true}, SHIFT(506),
  ...
  [1053] = {.count = 1, .reusable = false}, SHIFT(528),
  [1055] = {.count = 1, .reusable = true}, SHIFT(529),
  [1057] = {.count = 1, .reusable = false}, SHIFT(530),
  [1059] = {.count = 1, .reusable = true}, SHIFT(531),
  [1061] = {.count = 1, .reusable = true}, SHIFT(532),
  [1063] = {.count = 1, .reusable = false}, SHIFT(533),
  [1065] = {.count = 1, .reusable = false}, SHIFT(534),
  [1067] = {.count = 1, .reusable = true}, SHIFT(535),
  [1069] = {.count = 1, .reusable = true}, SHIFT(536),
  [1071] = {.count = 1, .reusable = true}, SHIFT(537),
  [1073] = {.count = 1, .reusable = true}, REDUCE(sym_command_part_var, 4),
  [1075] = {.count = 1, .reusable = true}, SHIFT(543),
  [1077] = {.count = 2, .reusable = false}, REDUCE(aux_sym_command_part_var_repeat1, 2), SHIFT_REPEAT(463),
  [1080] = {.count = 1, .reusable = false}, REDUCE(aux_sym_command_part_var_repeat1, 2),
  [1082] = {.count = 1, .reusable = true}, REDUCE(aux_sym_command_part_var_repeat1, 2),
  [1084] = {.count = 1, .reusable = true}, REDUCE(sym_task_output_kv, 4),
